...
void stat_sender::on_data_load(const std::vector<item>&, const std::vector<item>& new_items){
...
void stat_sender::async_send(const std::vector<item>& items, std::string_view path) {
